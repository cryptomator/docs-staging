"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([["106"],{4138(e,i,r){r.d(i,{A:()=>s});var t=r(1325),a=r(489);let l=a.createContext(!1);function n({children:e,className:i,columns:r=1,columnsSmall:d,columnsLarge:o}){let s=a.Children.toArray(e),c=r||s.length,m=a.useId();return(0,t.jsxs)("div",{style:{marginBottom:"var(--ifm-leading)"},children:[(0,t.jsx)("style",{children:`
          .grid-${m} {
            display: grid;
