...
![Vault detail view in the unlocked state](/img/desktop/encrypted-file-names-vault-detail-unlocked.png)
...
## Decrypt File Name[​](#decrypt-file-name "Direct link to Decrypt File Name")
...
## Technical Example[​](#technical-example "Direct link to Technical Example")
...
This is why you cannot identify files in the vault storage location by name alone without decrypting them first. For more information about the vault encryption scheme read [the specification](/security/vault/.md).
