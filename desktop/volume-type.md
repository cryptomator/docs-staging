...
WebDAV on Windows uses the [`net use`](https://learn.microsoft.com/en-us/previous-versions/windows/it-pro/windows-server-2012-R2-and-2012/gg651155\(v=ws.11\)) command to mount/unmount the virtual drive. The unlocked vaults is displayed as a network drive and assigned to a random drive letter.
