...
The configuration steps specific to Hub are covered below: [connecting an external identity provider](#connecting-an-external-identity-provider), [restricting who may access Hub](#restricting-access-to-hub), and [migrating to another identity provider](#migrating-to-another-identity-provider).

## Connecting an External Identity Provider[​](#connecting-an-external-identity-provider "Direct link to Connecting an External Identity Provider")
...
### OpenID Connect[​](#openid-connect "Direct link to OpenID Connect")
...
### Mapping Groups to Roles[​](#mapping-groups-to-roles "Direct link to Mapping Groups to Roles")
...
### LDAP and Active Directory[​](#ldap-and-active-directory "Direct link to LDAP and Active Directory")
...
### Using the Identity Provider as Default Login[​](#using-the-identity-provider-as-default-login "Direct link to Using the Identity Provider as Default Login")
...
### Skipping the Account Creation Screen[​](#skipping-the-account-creation-screen "Direct link to Skipping the Account Creation Screen")
...
### Customizing the Username[​](#customizing-the-username "Direct link to Customizing the Username")
...
## Restricting Access to Hub[​](#restricting-access-to-hub "Direct link to Restricting Access to Hub")
...
## Migrating to Another Identity Provider[​](#migrating-to-another-identity-provider "Direct link to Migrating to Another Identity Provider")
...
### Linking Accounts Manually[​](#linking-accounts-manually "Direct link to Linking Accounts Manually")
...
### Linking Accounts During Login[​](#linking-accounts-during-login "Direct link to Linking Accounts During Login")
...
### Forcing the Migration[​](#forcing-the-migration "Direct link to Forcing the Migration")
