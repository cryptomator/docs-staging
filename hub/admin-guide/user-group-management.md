...
After creation, the user can log in with their credentials and complete the [account setup](/hub/user-guide/your-account/.md#account-setup).
...
* **Legacy Devices**: Devices registered with older Hub versions (see [Legacy Devices](/hub/user-guide/your-account/.md#legacy-devices))
...
See [Identity Provider](/hub/admin-guide/keycloak/.md) for how to connect and manage an external identity provider.
