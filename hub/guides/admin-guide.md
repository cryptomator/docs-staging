...
* A running Hub instance — a local test instance from the [Quick Start](/hub/quick-start/.md) or a server deployment (managed or selfhosted)
* An account with the `admin` [role](/hub/user-group-management/.md#roles), such as the initial admin account created during deployment.
...
Bob and Carol can now log in and complete their account setup, as described in the [User Guide](/hub/guides/user-guide/.md#set-up-your-account).

For more details, read [Create User](/hub/user-group-management/.md#create-user), [Create Group](/hub/user-group-management/.md#create-group), and [Manage Group Members](/hub/user-group-management/.md#manage-group-members).
...
* [OpenID Connect](/hub/keycloak/.md#openid-connect) providers such as Microsoft Entra ID or Google Workspace.
* [LDAP and Active Directory](/hub/keycloak/.md#ldap-and-active-directory) for user federation.
* [Mapping groups to roles](/hub/keycloak/.md#mapping-groups-to-roles), e.g. to grant an *IT* directory group the `admin` role automatically.

For more details, read [Connecting an External Identity Provider](/hub/keycloak/.md#connecting-an-external-identity-provider) and [External Identity Management](/hub/user-group-management/.md#enterprise-external-iam).
...
For more details, read [Emergency Access admin settings](/hub/admin/.md#emergency-access), [Set Up Emergency Access](/hub/emergency-access/.md#set-up-emergency-access), and the per-vault [Emergency Access Council](/hub/vault-management/.md#emergency-access-council).
...
For more details, read [Audit Logs](/hub/admin/.md#audit-logs), [Filtering Audit Logs](/hub/admin/.md#filtering-audit-logs), and the list of [Event Types](/hub/admin/.md#event-types).
...
For more details, read [License](/hub/admin/.md#license), [What Is a Seat?](/hub/admin/.md#what-is-a-seat), and [Updating Your License](/hub/admin/.md#updating-your-license).

## Next Steps[​](#next-steps "Direct link to Next Steps")

* Set up [backups](/hub/operations/.md#backup) before real data accumulates.
* Harden logins with [session timeouts](/hub/keycloak/.md#session-timeouts) and [access restrictions](/hub/keycloak/.md#restricting-access-to-hub).
* Send your team the [User Guide](/hub/guides/user-guide/.md) so they can get started on their own.
