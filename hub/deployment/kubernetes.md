...
Using Rancher? The same chart can be installed through its UI, see [Rancher](/hub/deployment/rancher/.md).

## Prerequisites[​](#kubernetes-prerequisites "Direct link to Prerequisites")
...
## Install[​](#kubernetes-install "Direct link to Install")
...
## Upgrading and Uninstalling[​](#kubernetes-upgrading "Direct link to Upgrading and Uninstalling")

[Back up the database](/hub/operations/.md#backup) first, then:
