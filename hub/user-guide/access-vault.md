...
Enter a name for the device to identify it later on and the [Account Key](/hub/user-guide/your-account/.md#account-key) which was generated during the account setup. You can also find it in the [account settings](/hub/user-guide/your-account/.md#profile-page).
